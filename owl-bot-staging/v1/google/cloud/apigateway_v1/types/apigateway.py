...
class Api(proto.Message):
    ...
    state = proto.Field(proto.ENUM, number=12,
        enum=State,
    )
...
class ApiConfig(proto.Message):
    ...
    class GrpcServiceDefinition(proto.Message):
        ...
        file_descriptor_set = proto.Field(proto.MESSAGE, number=1,
            message='ApiConfig.File',
        )

        source = proto.RepeatedField(proto.MESSAGE, number=2,
            message='ApiConfig.File',
        )
    ...
    openapi_documents = proto.RepeatedField(proto.MESSAGE, number=9,
        message=OpenApiDocument,
    )

    grpc_services = proto.RepeatedField(proto.MESSAGE, number=10,
        message=GrpcServiceDefinition,
    )

    managed_service_configs = proto.RepeatedField(proto.MESSAGE, number=11,
        message=File,
    )
...
class ListGatewaysResponse(proto.Message):
    ...
    gateways = proto.RepeatedField(proto.MESSAGE, number=1,
        message='Gateway',
    )
...
class CreateGatewayRequest(proto.Message):
    ...
    gateway = proto.Field(proto.MESSAGE, number=3,
        message='Gateway',
    )
...
class UpdateGatewayRequest(proto.Message):
    ...
    gateway = proto.Field(proto.MESSAGE, number=2,
        message='Gateway',
    )
...
class ListApisResponse(proto.Message):
    ...
    apis = proto.RepeatedField(proto.MESSAGE, number=1,
        message='Api',
    )
...
class CreateApiRequest(proto.Message):
    ...
    api = proto.Field(proto.MESSAGE, number=3,
        message='Api',
    )
...
class UpdateApiRequest(proto.Message):
    ...
    api = proto.Field(proto.MESSAGE, number=2,
        message='Api',
    )
...
class ListApiConfigsResponse(proto.Message):
    ...
    api_configs = proto.RepeatedField(proto.MESSAGE, number=1,
        message='ApiConfig',
    )
...
class CreateApiConfigRequest(proto.Message):
    ...
    api_config = proto.Field(proto.MESSAGE, number=3,
        message='ApiConfig',
    )
...
class UpdateApiConfigRequest(proto.Message):
    ...
    api_config = proto.Field(proto.MESSAGE, number=2,
        message='ApiConfig',
    )
...
class OperationMetadata(proto.Message):
    ...
    diagnostics = proto.RepeatedField(proto.MESSAGE, number=8,
        message=Diagnostic,
    )
